...
@log export class SKNPaymentPage extends Page {
    ...
    @component("//auto-complete[@formcontrolname='residStatus']") public beneficiaryResident: OptionSelect;
    @component('//auto-complete[@formcontrolname="category"]') public beneficiaryCategory: OptionSelect;
    ...
    public async goToViewPaymentPageViaRef(_PaymentsPages: PaymentsPages, reference: string) {
        ...
        await this.loadConditionForViewSKNPaymentPage();
    }
