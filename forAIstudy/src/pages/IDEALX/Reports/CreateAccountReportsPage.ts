 ...
 */
import { Button, component, log, DateSelect, OptionSelect, Page, RadioButton, TextInput, waitForUXLoading } from "../../../lib";
import { browser, ExpectedConditions } from "protractor";

@log export class CreateAccountReportsPage extends Page {
    @component('//*[@name="reportName"]') public reportName: TextInput;
    @component('//*[@value="VA"]') public virtualAccounts: Button;
    ...
    @component('//*[@id="label-multi-dropdown-transactionItemStatus"]') public itemStatus: Button;
    @component('//*[@id="label-multi-dropdown-transactionStatus"]') public txnStatus: Button;
    @component('//*[@id="status-0"]') public statusItem: Button;
    @component('//*[@id="transactionItemStatus-0"]') public itemStatusItem: Button;
    @component('//*[@id="transactionStatus-0"]') public txnStatusItem: Button;
    @component('//div[@id="label-multi-dropdown-transactionType"]') public accountType: Button;
    ...
    @component('//*[@name="chequeNumber"]') public chequeNumber: TextInput;
    @component('//*[@name="groupReference"]') public groupReference: TextInput;
    @component('//input[@name="depositSlipNumber"]') public depositSlipNumber: TextInput;
    @component('//input[@name="instrumentNumber"]') public instrumentNumber: TextInput;
    ...
    @component('//*[@value="R" and @name="dateRange"]') public relativeDates: RadioButton;
    @component('//*[@value="S" and @name="reportCreation"]') public scheduled: RadioButton;
    ...
    @component('//*[@formcontrolname="startAbsoluteDate"]') public startAbsoluteDate: DateSelect;
    @component('//*[@formcontrolname="endAbsoluteDate"]') public endAbsoluteDate: DateSelect;
    @component('//*[@value="VA"]') public VAaccountType: Button;

    @component('//p-auto-complete[@formcontrolname="dailyInThe"]') public dailyInThe: OptionSelect;
    @component('//*[@id="dailyInThe"]') public dailyinThe: TextInput;
    ...
    @component('//*[@id="label-multi-dropdown-paymentCurrencies"]') public payCurDropDown: Button;
    ...
    @component('//*[@id="reportTypes-panel"]/report-types/div/ul/li[2]/div[2]/saved-report-payment/div[1]/ux-datatable/div/datatable-header/div/div[2]/datatable-header-cell[1]/div/div/input') public selectAll4TransferSumDetReport: Button;
    @component('//input[@name="selectAllName"]') public selectMultiToDeleteButton: Button;
    @component('//dbs-radio-group[@formcontrolname="deliverySchedule"]') public deliverySchedule: RadioButton;
    @component('//button[@name="next"]') public nextToGenerate: Button;
    @component('//*[@class="ui-autocomplete-list-item-wrappe"]') public dailyResult: Button;
    @component('//input[@name="fileName"]') public fileNameInput: TextInput;
    @component('//div[@id="label-multi-dropdown-fileStatus"]') public fileStatus: Button;
    @component('//*[@id="fileStatus-0"]') public fileStatusItem0: Button;
    @component('//input[@name="payeeReference"]') public payeeReference: TextInput;
    ...
    @component('//dbs-radio-group/div/dbs-radio[5]/div/label/div/span') public deliveryFormat: RadioButton;
    // add new email
    @component('//button[@id="addNewEmail"]') public addNewEmail: Button;
    @component('//input[@id="nickname0-input"]') public newEmailNickname: TextInput;
    @component('//input[@id="address0-input"]') public newEmailAdress: TextInput;
    @component('//button[@id="saveAndCloseEmail"]') public saveAndCloseEmailButton: Button;
    @component('//*[@id="label-multi-dropdown-sendTo"]/div/span[1]') public sendToSelectedText: TextInput;
