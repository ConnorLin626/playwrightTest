...
import { Page, component, log, Button, TextInput, waitForI3Loading, HtmlSelect, pageSwitchWindow, waitForUXLoading } from '../../../lib';
...
@log export class PaymentReportsPage extends Page {
    ...
    @component('//*[@id="navAIThirdReportsLinkText"]') public reportMenu: Button;
    @component('//*[@id="bulkPayment-generate-button"]') public bulkPaymentPersonaliseButton: Button;
    @component('//*[@id="bulkPayment-create"]') public bulkPaymentCreateButton: Button;
    @component('//*[@id="report-expand-type-8"]') public showBulkTemplate: Button;
    ...
    @component('//input[@name="reportName"]') public customRptNameText: TextInput;
    @component('//input[@name="dateRange" and @value="A"]') public absoluteDateValue: Button;
    ...
    @component('//*[@name="next"]') public continueButton: Button;
    @component('//*[@name="publish"]') public updateButton: Button;
    ...
    @component('//table[contains(@class,"style_") and contains(@id,"AUTOGENBOOKMARK_")]/tbody/tr[2]/td[3]/div') public bulkPaymentAccountValue: TextInput;
    @component('//table[@class = "style_12" and contains(@id,"AUTOGENBOOKMARK_3_")]/tbody/tr[3]/td[3]/div') public transferDetailAccountValue: TextInput;
    ...
    @component('//table[contains(@class, "style_") and contains(@id,"AUTOGENBOOKMARK_")]/tbody/tr[2]/td[3]/div') public accountValue4Reports: TextInput;
    @component('//table[contains(@class, "style_") and contains(@id,"AUTOGENBOOKMARK_")]/tbody/tr[3]/td[3]/div') public accountValue4Reports1: TextInput;
    @component('//table[contains(@class, "style_") and contains(@id,"AUTOGENBOOKMARK_")]') public accountValue4Reports2: TextInput;
    @component('//table[@id="__bookmark_1"]/tbody/tr[3]/td[3]/div') public accountValue4StatusReports: TextInput;
    @component('//table[contains(@class, "style_") and contains(@id,"AUTOGENBOOKMARK_")]/tbody/tr[4]/td[3]/div') public accountValue4PayAdvReports: TextInput;
    ...
    @component('//table[contains(@class, "style_") and contains(@id,"AUTOGENBOOKMARK_")]/tbody/tr/td[3]/div') public accountValue4PayCur: TextInput;
    @component('//table[contains(@class, "style_")]/tbody/tr[1]/td[3]/div') public fileNameValue4FileReports: TextInput;
    @component('//table[contains(@class, "style_")]/tbody/tr[1]/td[3]/div') public fileNameValue4FileReports1: TextInput;
    @component('//table[contains(@class, "style_")]/tbody/tr[2]/td[3]/div') public accountValue4FileReports: TextInput;
