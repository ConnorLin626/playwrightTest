...
@log export class CorporationsPage extends Page {
  ...
  @component('//a[@href="/samweb/csr/common/corp/corporationEdit/assistUser?id='+(SIT ? TWtestData.Resources.SIT.Assist.idealXId : TWtestData.Resources.UAT.Assist.idealXId)+'&a='+(SIT ? TWtestData.Resources.SIT.Assist.Affiliate : TWtestData.Resources.UAT.Assist.Affiliate)+'"]') public twOBUAssist: Button;
