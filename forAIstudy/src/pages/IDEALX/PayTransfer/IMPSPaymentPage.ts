...
@log export class IMPSPaymentPage extends Page {
    //Create page
    ...
    @component("//*[@id='ux-tab-NEWIMPSPAYEE']/span") public newIMPSPayeeTab: Button;
    @component("//*[@name='mmid-input']") public impsMMID: TextInput;
    @component("//*[@name='proxyTypeMobNumInput']") public impsMobileNumber: TextInput;
    ...
    @component("//*[@id='imps_type']") public impsBtn: TextInput;

    // View IMPS Payment Page
    ...
    @component('//*[@id="domestic-view-newPayee-name"]') public toPayeeValue: TextInput;
    @component('//*[@id="domestic-view-existingPayee-name"]') public toExistingPayeeValue: TextInput;
    @component('//*[@id="domestic-view-existingPayee-acctNum"]') public toExistingPayeeAcctNum: TextInput;
    @component('//*[@id="domestic-view-existingPayee-ifsc"]') public toExistingPayeeIFSC: TextInput;
    ...
    // create IMPS Page from template
   ...
   // Create IMPS Tempate Page
   @component('//a[@id="singleTemplate-IN"]') public createSinglePaymentTemplateButton: Button;
   @component('//a[@id="template-list-templateName_0"]') public templateNameLink: Button;
    ...
    public async loadConditionForViewIMPSPaymentPage() {
        await waitForUXLoading();
        ...
        //await browser.sleep(3000) //wait for status field load 
    }
    ...
    public async goToViewPaymentPageViaRef(_PaymentsPages: PaymentsPages, reference: string) {
        ...
        await this.loadConditionForViewIMPSPaymentPage();
    }
}
