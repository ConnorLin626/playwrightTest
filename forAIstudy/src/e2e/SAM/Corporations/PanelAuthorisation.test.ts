...
describe('Panel Authorisation', async function () {
    ...
    it('Panel Authorisation - Edit Group', async function () {
        ...
        await _CorporationsPages.corporationsPage.inputAffiliate.input(testDataSAM.searchAffiliateValue.PASGAffiliate);
        ...
        await ensure(_CorporationsPages.corporationsPage.groupUsersValue).textContains(testDataSAM.groupUsers.AUTOSG02C03);
        await ensure(_CorporationsPages.corporationsPage.groupName).textContains(testDataSAM.groupName.GroupE);
        if (await _CorporationsPages.corporationsPage.groupUsersValue.textContains(testDataSAM.groupUsers.AUTOSG01S01)) {
            userIfExist = true;
        } else {
            userIfExist = false;
        }
        ...
        if (userIfExist) {
            await _CorporationsPages.corporationsPage.selectedUsers.select(testDataSAM.groupUsers.AUTOSG01S01);
            ...
            await ensure(_CorporationsPages.corporationsPage.groupUsersValue).textNotContains(testDataSAM.groupUsers.AUTOSG01S01);
        } else {
            await _CorporationsPages.corporationsPage.noSelectedUsers.select(testDataSAM.groupUsers.AUTOSG01S01);
            await _CorporationsPages.corporationsPage.addUsersButton.click();
            await _CorporationsPages.corporationsPage.previewGroupButton.click();
            await ensure(_CorporationsPages.corporationsPage.groupUsersValue).textContains(testDataSAM.groupUsers.AUTOSG01S01);
        }
