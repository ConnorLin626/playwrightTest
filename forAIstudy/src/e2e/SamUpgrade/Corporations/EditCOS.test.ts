...
describe('COS', async function () {
    ...
    it('Edit COS', async function () {
        ...
        await _CorporationsPages.corporationsPage.editCorpButton.jsClick();
        await _CorporationsPages.corporationsPage.cosEntryLink.click();
        await _CorporationsPages.corporationsPage.auBulkPaymentAllowAccess.click();
        await _CorporationsPages.corporationsPage.preCosButton.jsClick();
        await _CorporationsPages.corporationsPage.submitCosButton.jsClick();
        await _CorporationsPages.corporationsPage.corpContinueButton.jsClick();
        await _CorporationsPages.corporationsPage.corpSubmitButton.jsClick();
