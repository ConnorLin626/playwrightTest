...
describe('Activities', async function () {
    ...
    before(async function () {
        await new NavigatePages().loginIdealx(
            ...
            SIT ? testData.Accounts.Activities.SIT.loginUserId : testData.Accounts.Activities.UAT.loginUserId, "123123");
    });
    ...
    it('Check Show more Detail', async function () {
        ...
        await _AccountPages.activitiesPage.showMoreDetailLink.jsClick();
    ...
    it('Click CSV icon in the NEW UI', async function () {
        ...
        await _AccountPages.activitiesPage.accountActivityTab.click();
...
async function displayActiviesWithSearch(): Promise<void> {
    ...
    await _AccountPages.activitiesPage.searchButton.jsClick();
