...
let testData = _AccountReportsListPage.fetchTestData("HKB_testData.json");
...
describe("Payment Summation by Currency Report", async function () {
    ...
    it("Create Payment Summation by Currency Report", async function () {
        ...
        await process4InitCommonValue("PayCur", _AccountReportsListPage.acctReportListPage.payCurCreateButton).then(text => {
