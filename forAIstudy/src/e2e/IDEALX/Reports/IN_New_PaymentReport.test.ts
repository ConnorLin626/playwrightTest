...
let testData = _AccountReportsListPage.fetchTestData("IN_testData.json");
...
describe("Group Detail Report", async function () {
    ...
    it("Create Group Detail Report", async function () {
        ...
        await process4InitCommonValue("GroupDet", _AccountReportsListPage.acctReportListPage.groupDetCreateButton).then(text => {
    ...
    it("Edit Group Detail Report", async function () {
        await _AccountReportsListPage.acctReportListPage.filterInput.input(groupDetReportName);
        await _AccountReportsListPage.acctReportListPage.groupDetActionButton.jsClick();
        await _AccountReportsListPage.acctReportListPage.groupDetEditButton.jsClick();
        ...
        await process4Schedule(
            ...
            _AccountReportsListPage.acctReportListPage.groupDetViewReportName,
            _AccountReportsListPage.acctReportListPage.groupDetViewAcct,
            _AccountReportsListPage.acctReportListPage.groupDetSendToValue
        );
    });
