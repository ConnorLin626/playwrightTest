...
let testData = _AccountReportsListPage.fetchTestData("TWOBU_testData.json");
...
describe("Bulk Payment Report", async function () {
    ...
    it("Create Bulk Payment", async function () {
        ...
        await process4InitCommonValue("BulkPayment",_AccountReportsListPage.acctReportListPage.bulkPaymentCreateButton).then(text => {
    ...
    it("Edit Bulk Payment", async function () {
        await _AccountReportsListPage.acctReportListPage.filterInput.input(bulkPaymentReportName);
