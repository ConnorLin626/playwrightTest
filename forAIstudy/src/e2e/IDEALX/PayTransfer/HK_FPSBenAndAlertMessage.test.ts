...
*/
import { NavigatePages, PaymentsPages, AlertsPages, } from '../../../pages/IDEALX';
...
describe('HK FPS Beneficiary', async function () {
    ...
    before(async function () { await new NavigatePages().loginIdealx(SIT ? testData.Beneficiary.SIT.loginCompanyId : testData.Beneficiary.UAT.loginCompanyId, SIT ? testData.Beneficiary.SIT.loginUserId : testData.Beneficiary.UAT.loginUserId, SIT ? testData.Beneficiary.SIT.pinId : testData.Beneficiary.UAT.pinId); });
    ...
    it('Create a new FPS Payee - Mobile', async function () {
        ...
        await _PaymentsPages.BeneficiaryPage.selectedCountry.select(testData.Beneficiary.Country);
    ...
    it('Create a new FPS Payee - Email', async function () {
        ...
        await _PaymentsPages.BeneficiaryPage.selectedCountry.select(testData.Beneficiary.Country);
        await _PaymentsPages.BeneficiaryPage.payNowProxy.click();
        await _PaymentsPages.BeneficiaryPage.proxyEmailRadio.jsClick();
